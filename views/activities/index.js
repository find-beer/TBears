                ...
                <View style={styles.tabWrap}>
                    <View style={styles.tabLine}>
                        <TouchableOpacity onPress={this.changeTab.bind(this, 0)} style={styles.cFlex}>
                            <Text style={[styles.tabName, currentTab === 0 ? styles.activeTab : styles.unactiveTab]}>带你</Text>
                            {currentTab === 0 && <View style={styles.tabBorder} />}
                        </TouchableOpacity>

                        <TouchableOpacity onPress={this.changeTab.bind(this, 1)} style={styles.cFlex}>
                            <Text style={[styles.tabName, currentTab === 1 ? styles.activeTab : styles.unactiveTab]}>参加</Text>
                ...
                <View style={styles.cardsWrap}>
                    {
                        activitiesMap.map((item) => (
                            <View style={styles.activityCard}>
                                ...
                                <Text style={[styles.cardText, styles.purpleText]}>{item.groupNum}人成团: {item.groupPrice}</Text>
