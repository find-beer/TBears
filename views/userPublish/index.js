            ...
            <View style={styles.contentWrap}>
                ...
                <View style={styles.mainContent}>
                    ...
                    <View style={styles.pictures}>
                        {
                            images.map((img, index) => (
                                <View key={index}>
                                    <Image style={[styles.picture, (index+1) % 3 && styles.picMargin]} source={img} />
                                </View>
                            ))
                        }
                        {images.length < 6 && <TouchableOpacity onPress={this.choosePicture} style={styles.addButton}>
                            <Image style={styles.addIcon} source={imageUrl.addPic} />
                    ...
                    <View style={styles.lineInfo}>
                        ...
                        <TouchableOpacity onPress={this.getLocation} style={styles.locateBtn}>
                            <Image style={styles.locationIcon} source={imageUrl.location} />
                            <Text style={styles.grayFont}>你在哪里</Text>
                        </TouchableOpacity>
                    </View>

                    {
                        isPunchCard && <View style={styles.dakaTag}>
                            <Text style={styles.tagText}>输入打卡标签:</Text>
                            <TextInput value={clockinTag} onChangeText={this.onChangeText.bind(this, 'clockinTag')} style={styles.tagInput} />
                        </View>
                    }

                    <View style={[styles.rFlex, styles.publishToCity]}>
                        <Text style={styles.chooseText}>是否允许发布到同城:</Text>
                        <View style={[styles.chooseBoxs, styles.rFlex]}>
                            <TouchableOpacity onPress={this.togglePublishInCity.bind(this, true)} style={styles.rFlex}>
                                <Image style={styles.chooseIcon} source={ isPublishInCity ? imageUrl.chooseBox : imageUrl.unchooseBox} />
                                <Text style={styles.chooseText}>是</Text>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={this.togglePublishInCity.bind(this, false)} style={styles.rFlex}>
                                <Image style={styles.chooseIcon} source={ !isPublishInCity ? imageUrl.chooseBox : imageUrl.unchooseBox} />
