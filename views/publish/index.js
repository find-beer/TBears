        ...
        return (
            <View style={styles.contentWrap}>
                    ...
                    activityInfos.map((item, index) => (
                        <View key={index}>
                            <InfoLine title={item.title}>
                                {
                                    item.infoType === 1 ? <TextInput onChangeText={this.onInputChange.bind(this, item)} placeholder={item.placeholder} /> :
                                    item.infoType === 2 || item.infoType === 4 ? <TouchableOpacity onPress={this.choosePicker.bind(this, item)}>
                                        {!!submitInfo[item.filedName] ? <Text>{submitInfo[item.filedName]}</Text> : <Text style={styles.placeholder}>{item.placeholder}</Text>}
                                    </TouchableOpacity> :
                                    <TouchableOpacity>
                ...
                <View style={styles.footer}>
                    ...
                    <Button style={{ backgroundColor: '#564F5F', flex: 1 }} textStyle={{ color: '#FFFFFF' }} title="立即发布" />
                </View>
